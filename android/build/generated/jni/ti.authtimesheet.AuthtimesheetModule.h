...
class AuthtimesheetModule : public titanium::Proxy
{
public:
	explicit AuthtimesheetModule(jobject javaObject);
...
private:
	// Methods -----------------------------------------------------------
	static v8::Handle<v8::Value> getAuthCode(const v8::Arguments&);
